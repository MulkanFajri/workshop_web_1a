                    ...
                    <div class="box-body">
                            ...
                            <table class="table table-striped table-bordered">
								...
								?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('transaksi/kembali');?>" class="btn btn-success">
                                            <i class="fa fa-refresh"></i> Refresh</a>

                                        <?php if($this->session->userdata('level') == 'Petugas'){ ?>
                                        <?php if(!empty($this->input->get('bln'))){?>
                                        <a href="<?= base_url('transaksi');?>/cetak?excel=yes&sortir=kembali&cari=yes&bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>"
                                            class="btn btn-info"><i class="fa fa-download"></i>
                                            Excel</a>
                                        <a href="<?= base_url('transaksi');?>/cetak?sortir=kembali&bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>"
                                            target="_blank" class="btn btn-warning btn-md"><i class="fa fa-print"></i>
                                            Print </a>
                                        <?php }else{?>
                                        <a href="<?= base_url('transaksi');?>/cetak?excel=yes&sortir=kembali"
                                            class="btn btn-info"><i class="fa fa-download"></i>
                                            Excel</a>
                                        <a href="<?= base_url('transaksi');?>/cetak?sortir=kembali" target="_blank"
                        ...
                        <center>
                            <h4> -
                                ...
                                Data Laporan Pengembalian <?= $bulan_tes[$this->input->get('bln')];?>
                                <?= $this->input->get('thn');?>
                                <?php }else{?>
						...
						?>
									...
									?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('transaksi/prosespinjam?tipe=kembali&pinjam_id='.$isi['pinjam_id']);?>"
