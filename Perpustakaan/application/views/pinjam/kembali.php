                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
											...
											$your_date = strtotime($pinjam->tgl_balik);
											...
											if($tenggat > 0 )
											{
												...
												echo '<p style="color:red;font-size:18px;">'.$this->M_Admin->rp($jml*($dd->harga_denda*$tenggat)).' 
                        ...
                        <div class="pull-right">
                            <a data-toggle="modal" data-target="#TableDenda" class="btn btn-primary btn-md"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        {
                                            $buku = $this->M_Admin->get_tableid_edit('tbl_buku','buku_id',$isi['buku_id']);
                                            echo $no.'. '.$buku->buku_id.' ( '.$buku->title.' ) <b>'.$isi['jml'].'x</b><br/>';
                                        $no++;}
